...
**Although entering an email address is optional, if you do not enter a valid email address to recover your password, this will make it very difficult to recover your account if you lost the password. Your email address will be used only to verify your identity on CyTube.**  
